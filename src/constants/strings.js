...
export const SHARE_GAME_MODAL_WORD = 'כל מילה שבא לכם';

export const GUESS_DISTRIBUTION_TEXT = 'מד כישלון';
export const NEW_WORD_TEXT = 'New word in';
export const SHARE_TEXT = 'Share';
export const CREATE_FROM_STAT_TEXT = 'יאללה שתפי עכשיו את';
